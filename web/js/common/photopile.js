...
var photopile = (function() {
    ...
    var thumbOverlap      = 30;         // overlap amount (px)
    var thumbRotation     = 50;         // maximum rotation (deg)
    var thumbBorderWidth  = 2;          // border width (px)
    var thumbBorderColor  = '#666';    // border color
    ...
    // Images
    var loading    = '${pageContext.request.contextPath}/resource/images/loading.gif';  // path to img displayed while gallery/thumbnails loads
